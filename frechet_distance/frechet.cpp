...
int main() {
    string filename1 = "codeBook1.txt";
    string filename2 = "codeBook2.txt";
    string filename3 = "codeBook3.txt";
    string filename4 = "codeBook4.txt";
    string filename5 = "codeBook5.txt";
    string filename6 = "test1.txt";
    string filename7 = "test2.txt";
    string filename8 = "test3.txt";
    string filename9 = "test4.txt";
    string filename10 = "test5.txt";
    string filename11 = "test6.txt";
    string filename12 = "test7.txt";
    string filename13 = "test8.txt";
    string filename14 = "test9.txt";
    string filename15 = "test10.txt";
    ...
    // double distance1 = frechetDistance(path1, path6);
    // cout << "Frechet distance: " << distance << endl;
